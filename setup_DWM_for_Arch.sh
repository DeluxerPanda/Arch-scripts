...
function Installing() {
    ...
    # System packages
    sudo pacman -S --needed --noconfirm base-devel libx11 libxft xorg-server xorg-xinit ffmpeg networkmanager network-manager-applet mate-polkit nfs-utils nano usbutils gnome-keyring fuse numlockx

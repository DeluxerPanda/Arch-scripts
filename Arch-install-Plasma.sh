...
pacman -Sy --noconfirm
pacman -S --needed --noconfirm kdeconnect starship bash-completion bat fastfetch btop pavucontrol mpv firefox feh plasma sddm konsole kate dolphin ark nfs-utils nano usbutils gnome-keyring fuse ffmpeg flatpak steam ttf-jetbrains-mono-nerd noto-fonts-emoji gamescope gparted
